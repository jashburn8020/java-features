...
- Have slightly different inheritance rules to regular methods
  ...
  - see [`defaultmethods/InheritanceRules.java`](/src/test/java/com/jashburn/javafeatures/java8/defaultmethods/InheritanceRules.java)
- It is possible to implement two interfaces, both provide `default` methods with the same signature
  ...
  - see [`defaultmethods/MultipleInheritance.java`](/src/test/java/com/jashburn/javafeatures/java8/defaultmethods/MultipleInheritance.java)
...
- See: [`optional/OptionalDemo.java`](/src/test/java/com/jashburn/javafeatures/java8/optional/OptionalDemo.java)
